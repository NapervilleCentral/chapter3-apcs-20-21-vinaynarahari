...
public class ch3notesper8
{
      ...
      public static void main (String [] args) throws IOException // required for File IO
   {
     ...
     for(int i = 0; i<5;i++)
     {
		 ...
		 num = Integer.parseInt(number);//convert "5" to digit 5
		 total += num;
 	 }
...
/**/
    ...
    //relative pathMexicoMexico
    // MUST BE IN THE SAME DIR/FOLDER AS THIS FILE
    ...
    String word;
    int total =0;
     while(scanFile2.hasNext())// iterate thru the file
    {
        word = scanFile2.next();//get each word
