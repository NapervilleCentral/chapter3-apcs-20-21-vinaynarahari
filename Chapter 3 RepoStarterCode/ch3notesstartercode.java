...
public class ch3notesstartercode
{
    public static void main (String [] args)
    {
        ...
        *//*
           ...
           // switch has cascading effect / /*  basically means that the code will run until the last line of code in a switch; can be fixed witha  break  */
           switch(choice){
               case 'h':
                   System.out.println("4.99");
                   break; // breaks out of the current structure // poor programming so dont do it with a break unless you have to (good for switch but not good for for loops or if statements
               case 'f':
